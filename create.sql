...
CREATE TABLE IF NOT EXISTS `Tungton`.`Product_logs` (
  ...
  `product_log_cost` INT NOT NULL,
  `product_log_price` INT NOT NULL,
  PRIMARY KEY (`product_id`, `store_id`),
  CONSTRAINT `fk_Product_logs_Product_in_stores1`
    FOREIGN KEY (`product_id` , `store_id`)
    REFERENCES `Tungton`.`Product_in_stores` (`store_id` , `product_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Tungton`.`Receipts` (
  ...
  `receipt_total_price` DECIMAL NOT NULL,
  `customer_money_paid` DECIMAL NOT NULL,
  `receipt_money_change` DECIMAL NOT NULL,
...
-- -----------------------------------------------------
-- Table `Tungton`.`Products_has_Receipts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Tungton`.`Products_has_Receipts` (
  `receipt_id` INT NOT NULL,
  `product_id` INT NOT NULL,
  `receipt_product_sale_quantity` INT NOT NULL,
  `receipt_product_sale_price` DECIMAL NOT NULL,
  `receipt_product_total_price` DECIMAL NOT NULL,
...
-- -----------------------------------------------------
-- Table `Tungton`.`Product_attributes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Tungton`.`Product_attributes` (
